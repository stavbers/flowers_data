...
let obj = {
  ...
  'sextion-eight': {
    ...
    'block': '#FECD4B',
    'imgTop': 'https://files.stavbers.site/couch-factory/svg/strujka.svg',
  ...
  'section-nine': {
      'title':'Бесплатно подберем ткани под ваш интерьер',
      'btn': {
        'bgColor': 'linear-gradient(180deg, #FECD4B 0%, #A57800 100%)',
        'text': 'Вызвать дизайнера на дом'
      },
  },
    'section-ten': {
      'title': 'Изготовление мебели на заказ в Харькове',
      'block': '#FECD4B',
      'imgTop': 'https://files.stavbers.site/couch-factory/svg/strujka.svg',
      'link1': 'Мягкая мебель',
      'link2': 'Корпусная мебель',
      'linkBg': 'linear-gradient(180deg, #FECD4B 0%, #A57800 100%)',
      'items1': [
        {
          'img': '',
          'name': '',
